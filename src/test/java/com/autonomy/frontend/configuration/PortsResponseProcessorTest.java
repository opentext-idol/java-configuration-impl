...
public class PortsResponseProcessorTest {
    ...
    public void testProcessWithCoordinator() throws XMLStreamException {
        ...
        final XMLStreamReader xmlStreamReader = TestUtils.getResourceAsXMLStreamReader("/com/autonomy/frontend/configuration/coordinatorGetStatusResponse.xml");
    ...
    public void testProcessWithGetChildren() throws XMLStreamException {
        ...
        final XMLStreamReader xmlStreamReader = TestUtils.getResourceAsXMLStreamReader("/com/autonomy/frontend/configuration/getChildrenResponse.xml");
